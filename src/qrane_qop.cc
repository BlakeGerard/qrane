...
void qrane_qop::set_qop_type(qop_type type) {
    this->t_qop = type;
};

qrane_qop::qop_type qrane_qop::get_qop_type() {
    return this->t_qop;
};
...
unsigned int qrane_qop::get_dim1_qop_num() {
    return this->dim1_qop_num;
}
...
void qrane_u::set_explist(qrane_explist* explist) {
    this->explist = explist;
};

void qrane_u::set_arglist(qrane_arglist* arglist) {
    this->arglist = arglist;
};

qrane_arglist* qrane_u::get_arglist() {
    return this->arglist;
};
...
std::string qrane_u::get_id() {
    return std::string("U");
};

std::size_t qrane_u::num_args() const {
    return 1;
};
...
void qrane_cx::set_arglist(qrane_arglist* arglist) {
    this->arglist = arglist;
};

qrane_arglist* qrane_cx::get_arglist() {
    return this->arglist;
}
...
std::string qrane_cx::get_id() {
    return std::string("CX");
};

std::size_t qrane_cx::num_args() const {
    return 2;
};
...
void qrane_custom::set_id(std::string id) {
    this->id = id;
};
...
qrane_arglist* qrane_custom::get_arglist() {
    return this->arglist;
};
...
std::string qrane_custom::get_id() {
    return this->id;
};

std::size_t qrane_custom::num_args() const {
...
qrane_arglist* qrane_measure::get_arglist() {
    return this->arglist;
};
...
std::string qrane_measure::get_id() {
    return std::string("measure");
};

std::size_t qrane_measure::num_args() const {
    return this->arglist->size();
};
...
qrane_arglist* qrane_reset::get_arglist() {
    return this->arglist;
};
...
std::string qrane_reset::get_id() {
    return std::string("reset");
};

std::size_t qrane_reset::num_args() const {
    return this->arglist->size();
};
