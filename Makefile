...
INCL = -I. -I./include -I./include/parsing -I$(AQUMA_INCL) -I$(PYTHON_HEAD) -I$(PYTHON_INCL) -I$(PYTHON_HOME) -I$(BARVINOK_INCL) -I$(NTL_INCL)
...
clean: 
	rm -rf qrane libqrane.so ${SCANNER}.c ${GRAMMER}.c ${GRAMMAR}.h ${GRAMMER}.output location.hpp compile_commands.json
