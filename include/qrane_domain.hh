...
class qrane_domain {
    ...
    public:
        ...
        std::vector<unsigned int> component_qops;	    // Tracks all global_ids within this domain
    ...
    private:
		...
		void build_affine_list_from_qop_ids(qasm_ops_list& qops_list, std::vector<unsigned int>& qop_ids);
};
